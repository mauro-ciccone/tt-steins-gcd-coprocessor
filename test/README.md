...
This directory contains the automated, cycle-accurate Python testbench for the Multi-Tool SoC. It uses [cocotb](https://docs.cocotb.org/en/stable/) to drive the hardware FSM, inject simulated physical noise, and verify the mathematical outputs of the coprocessors.
